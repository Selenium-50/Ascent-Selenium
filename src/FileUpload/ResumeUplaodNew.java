...
public class ResumeUplaodNew {
	...
	public void TestUpload() throws Exception{
		...
		driver.findElement(By.id("emailId")).sendKeys("testselenium6may7791@gmail.com");
	
		driver.findElement(By.id("emailRe")).sendKeys("testselenium6may7791@gmail.com");
